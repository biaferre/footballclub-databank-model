...
CREATE TABLE tb_cliente_loja OF tp_cliente_loja (
    ...
    preco NOT NULL,
    ID_cupom WITH ROWID REFERENCES tp_cupom NOT NULL,
    CNPJ_loja WITH ROWID REFERENCES tp_loja NOT NULL,
    CPF_cliente WITH ROWID REFERENCES tp_cliente NOT NULL,
    PRIMARY KEY (data_venda, produto, CNPJ_loja, CPF_cliente)
);
/
